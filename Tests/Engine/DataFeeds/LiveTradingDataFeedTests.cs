...
namespace QuantConnect.Tests.Engine.DataFeeds
{
    ...
    public class LiveTradingDataFeedTests
    {
        ...
        public void SubscribesToOnlyEquityAndForex()
        {
            ...
            Assert.IsFalse(dataQueueHandler.Subscriptions.Contains(new FuncDataQueueHandler.Subscription("RemoteFile", SecurityType.Base)));
        }
    ...
    public class TestableLiveTradingDataFeed : LiveTradingDataFeed
    {
        ...
        public TestableLiveTradingDataFeed(IDataQueueHandler dataQueueHandler)
        {
    ...
    public class FuncDataQueueHandler : IDataQueueHandler
    {
        ...
        public class Subscription : IEquatable<Subscription>
        {
            ...
            public Subscription(Symbol symbol, SecurityType securityType)
            {
                Symbol = symbol;
