    ...
    public class LiveTradingDataFeed : IDataFeed
    {
        ...
        public void StreamStoreConsumer()
        {
            ...
            var symbols = (from security in _algorithm.Securities.Values
                           where !security.SubscriptionDataConfig.IsDynamicallyLoadedData && (security.Type == SecurityType.Equity || security.Type == SecurityType.Forex)
            ...
            DateTime periodEnd)
        {
            ...
            if (security.SubscriptionDataConfig.IsDynamicallyLoadedData)
            {
