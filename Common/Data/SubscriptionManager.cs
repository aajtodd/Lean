...
namespace QuantConnect.Data
{
    ...
    public class SubscriptionManager
    {
        ...
        /// <param name="isDynamicallyLoaded">True if this is custom user supplied data, false for normal QC data</param>
        ...
        public SubscriptionDataConfig Add(SecurityType security, Symbol symbol, Resolution resolution, string market, DateTimeZone timeZone, bool isDynamicallyLoaded = false, bool fillDataForward = true, bool extendedMarketHours = false)
        {
            ...
            return Add(dataType, security, symbol, resolution, market, timeZone, isDynamicallyLoaded, fillDataForward, extendedMarketHours, false);
        }
        ...
        /// <returns>The newly created <see cref="SubscriptionDataConfig"/></returns>
        public SubscriptionDataConfig Add(Type dataType, SecurityType security, Symbol symbol, Resolution resolution, string market, DateTimeZone timeZone, bool isDynamicallyLoaded, bool fillDataForward = true, bool extendedMarketHours = false, bool isInternalFeed = false) 
        {
            if (timeZone == null)
            {
            ...
            //Create:
            var newConfig = new SubscriptionDataConfig(dataType, security, symbol, resolution, market, timeZone, fillDataForward, extendedMarketHours, isInternalFeed, isDynamicallyLoaded);
